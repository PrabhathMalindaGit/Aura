...
- `dashboard/src/services/clinicianApi.ts`
- `dashboard/src/services/clinicianApi.test.ts`
...
- `cd "/Users/University/Final Project/aura/server" && npm run build`
  - Passed: `tsc -p tsconfig.json` completed with exit code 0.
...
- Docker, MongoDB, backend dev server, and dashboard dev server were not started.
