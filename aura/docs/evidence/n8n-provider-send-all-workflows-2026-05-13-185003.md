...
- Status: FAIL
- Timestamp: 2026-05-13T18:50:03.081Z
- Run ID: 9987ce15-4df3-410b-98b5-50d7dccf0bb4
- Synthetic marker: `aura-n8n-provider-send-all:9987ce15-4df3-410b-98b5-50d7dccf0bb4`
...
- [x] Workflow 01 provider-send path: Synthetic high-risk alert 6a04c7dba1b6e60c1b89731e reached delivered/sent callback evidence.
- [x] Workflow 02 n8n proxy no Telegram expected: Workflow 02 is a list-alerts proxy; no Telegram send expected.
- [x] Workflow 03 missed check-in provider-send-all backend preflight: items=1; expectedSyntheticDedupeKeys=missed-checkin:verify-9987ce15:9:2026-05-13
- [x] Workflow 04 task reminder provider-send-all backend preflight: items=2; expectedSyntheticDedupeKeys=task-reminder:6a04c7dc4d49451a9c398b10:overdue:1, task-reminder:6a04c7dca1b6e60c1b89734c:overdue:1
- [x] Workflow 06 appointment provider-send-all backend preflight: items=1; expectedSyntheticDedupeKeys=appointment:6a04c7dc4d49451a9c398b14:missed:2026-05-13
...
- providerSendAlertId: 6a04c7dba1b6e60c1b89731e
- providerSendNotificationJob: {"jobId":"6a04c7dbf8f465afcb703f13","state":"delivered","channel":"telegram","dispatchKind":"initial","attemptCount":1,"lastCallbackStatus":"sent","messageId":"117"}
- providerSendNotificationJobId: 6a04c7dbf8f465afcb703f13
- providerSendProviderMessageId: 117
- providerSendNotificationEventId: 6a04c7dca1b6e60c1b897332
- syntheticMarker: aura-n8n-provider-send-all:9987ce15-4df3-410b-98b5-50d7dccf0bb4
- syntheticPatientId: verify-9987ce15
- syntheticAlertId: 6a04c7dc4d49451a9c398b0e
- syntheticTaskId: 6a04c7dc4d49451a9c398b10
- syntheticAppointmentRequestId: 6a04c7dc4d49451a9c398b14
- syntheticCommunicationReviewId: 6a04c7dc4d49451a9c398b17
- syntheticCommunicationMessageId: 6a04c7dc4d49451a9c398b16
- workflow03ExpectedDedupeKeys: missed-checkin:verify-9987ce15:9:2026-05-13
- workflow04ExpectedDedupeKeys: task-reminder:6a04c7dc4d49451a9c398b10:overdue:1, task-reminder:6a04c7dca1b6e60c1b89734c:overdue:1
- workflow06ExpectedDedupeKeys: appointment:6a04c7dc4d49451a9c398b14:missed:2026-05-13

## Failure Diagnostics

- 07 - Daily Digest (Cron 09:00 → Aura Digest → Telegram → Callback) provider-send-all preflight returned no eligible synthetic/demo dedupe keys. This can happen if today's dedupe key was already sent/skipped or the synthetic fixture no longer matches the process criteria.
