...
- Status: FAIL
- Timestamp: 2026-05-13T18:59:36.693Z
- Run ID: 2ce88d4b-ae3b-4bc0-91cc-9b38830cc292
- Synthetic marker: `aura-n8n-provider-send-all:2ce88d4b-ae3b-4bc0-91cc-9b38830cc292`
...
- [x] Workflow 01 provider-send path: Synthetic high-risk alert 6a04ca19a1b6e60c1b897394 reached delivered/sent callback evidence.
- [x] Workflow 02 n8n proxy no Telegram expected: Workflow 02 is a list-alerts proxy; no Telegram send expected.
- [x] Workflow 03 missed check-in provider-send-all backend preflight: items=2; expectedSyntheticDedupeKeys=missed-checkin:verify-2ce88d4b:9:2026-05-13
- [x] Workflow 04 task reminder provider-send-all backend preflight: items=4; expectedSyntheticDedupeKeys=task-reminder:6a04ca1a5d515fee28fe5b03:overdue:1, task-reminder:6a04ca1aa1b6e60c1b8973c6:overdue:1
- [x] Workflow 06 appointment provider-send-all backend preflight: items=2; expectedSyntheticDedupeKeys=appointment:6a04ca1a5d515fee28fe5b07:missed:2026-05-13
- [x] Workflow 07 local/demo digest dedupe reset: [REDACTED_TOKEN_LIKE_VALUE]=true; removed 2 local/demo daily_clinician_digest AUTOMATION_STATUS sent/skipped record(s) for dedupeKey=daily-digest:2026-05-13.
...
- providerSendAlertId: 6a04ca19a1b6e60c1b897394
- providerSendNotificationJob: {"jobId":"6a04ca19f8f465afcb70400b","state":"delivered","channel":"telegram","dispatchKind":"initial","attemptCount":1,"lastCallbackStatus":"sent","messageId":"118"}
- providerSendNotificationJobId: 6a04ca19f8f465afcb70400b
- providerSendProviderMessageId: 118
- providerSendNotificationEventId: 6a04ca1aa1b6e60c1b8973a8
- syntheticMarker: aura-n8n-provider-send-all:2ce88d4b-ae3b-4bc0-91cc-9b38830cc292
- syntheticPatientId: verify-2ce88d4b
- syntheticAlertId: 6a04ca1a5d515fee28fe5b01
- syntheticTaskId: 6a04ca1a5d515fee28fe5b03
- syntheticAppointmentRequestId: 6a04ca1a5d515fee28fe5b07
- syntheticCommunicationReviewId: 6a04ca1a5d515fee28fe5b0a
- syntheticCommunicationMessageId: 6a04ca1a5d515fee28fe5b09
- workflow03ExpectedDedupeKeys: missed-checkin:verify-2ce88d4b:9:2026-05-13
- workflow04ExpectedDedupeKeys: task-reminder:6a04ca1a5d515fee28fe5b03:overdue:1, task-reminder:6a04ca1aa1b6e60c1b8973c6:overdue:1
- workflow06ExpectedDedupeKeys: appointment:6a04ca1a5d515fee28fe5b07:missed:2026-05-13
- workflow07DigestDedupeKey: daily-digest:2026-05-13
- workflow07DigestDedupeResetCount: 2
- workflow07DigestDedupeResetEventKeys: automation:daily_clinician_digest:sent:daily-digest:2026-05-13, automation:daily_clinician_digest:skipped:daily-digest:2026-05-13
- workflow07ExpectedDedupeKeys: daily-digest:2026-05-13

## Failure Diagnostics

- 08 - Communication No-Response Escalation (Cron → Aura Process → Telegram → Callback) provider-send-all preflight returned no eligible synthetic/demo dedupe keys. This can happen if today's dedupe key was already sent/skipped or the synthetic fixture no longer matches the process criteria.
