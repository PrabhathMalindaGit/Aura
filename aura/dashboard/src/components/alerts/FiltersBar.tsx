...
export function FiltersBar({
  ...
  return (
    <section className="alerts-filters" aria-label="Alert filters">
      <div className="alerts-filters__row alerts-filters__row--primary">
        <label className="alerts-filters__search form-field">
          <span className="alerts-filters__label">Search alerts</span>
          <input
            type="search"
            value={searchValue}
      ...
      <div className="alerts-filters__row alerts-filters__row--secondary">
        <div className="alerts-filters__group-wrap">
          <span className="alerts-filters__toolbar-label">Source</span>
        ...
        {status === 'open' ? (
          <div className="alerts-filters__toggle-wrap">
            <span className="alerts-filters__toolbar-label">Open review</span>
